...
import { ChevronRight, Bell, Lock, CreditCard, Download, Repeat, ArrowLeft, HelpCircle, Mail, Users, LogOut, AlertCircle, Loader, Camera, ShieldCheck, CheckCircle2, Clock, XCircle, ArrowDownLeft, ArrowUpRight, MailCheck, Copy, Info, BookOpen } from 'lucide-react';
...
const LoginSignupForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-8 bg-card rounded-2xl shadow-xl animate-fade-in">
